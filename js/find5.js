...
//document.write('<input type="button" value="Click para buscar articulo..."'
//	+ ' onclick="show();">');
...
//$("#boton-buscar").appendChild('<input type="button" value="Click p articulo..." onclick="show();">');
//$("#boton-buscar").empty().append('Custom price:<br><input type="text" name="amount"/>')
//document.getElementById('boton_buscar').innerHTML += '<input type="text" name="amount" />';

  //document.getElementById('boton-buscar').innerHTML = "";
  //var newInput = document.createElement("input");
  //newInput.type="button";
  //newInput.value="amount";
  //newInput.onclick="show();"
  //document.getElementById('boton-buscar').appendChild(newInput);
