      ...
      <aside class="col-xs-4 col-sm-4 col-md-3 pedido-num">
                    ...
                    <div class="panel panel-red">
                        ...
                        <div class="panel-footer">
                            ...
                            <div><small>Estatus</small><span class="pull-right" id="estatus_cliente"><small><?php echo $hayPedido ? toCurrency($rsPedido['limite_credito']) : ''; ?></small></span></div>
...
-->        
  ...
  <div class="form-group row">
    <label for="direccion_entrega" class="col-xs-2 col-sm-2 form-control-label">Direccion Entrega</label>
      ...
      <textarea class="form-control" id="direccion_entrega" name="direccion_entrega" required></textarea>
    ...
    <div class="panel panel-default">
      <div class="panel-body ">
        ...
        <div class="row form-group col-xs-12" id="div_producto_general" style="display:none;">
            <a href="#modalTable" data-toggle="modal" class="default">O seleccionar un producto "NO de Linea"</a>          
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Productos NO de Linea</h4>
                        </div>
                          ...
                          <div class="bootstrap-table">
                            ...
                            <div class="table-container" style="padding-bottom: 0px;">
                              ...
                              <div class="fixed-table-body">
                                ...
                                <table 
                                  id="tablaProductosNoLinea"
                                  data-toggle="table" 
                                  class="table table-hover" 
                                  data-sort-name="descripcion"
                                  data-sort-order="asc"
                                  data-search="true"
                                  ...
                                  <thead>
                                    <tr>
                                      ...
                                      <th data-field="codigo_producto"   data-sortable="true" data-align="left">Codigo</th>
                                      <th data-field="descripcion"       data-sortable="true" data-align="left">Descripcion</th>
                                    </tr>
                                  </thead>
                                  <tbody>
                                      <?php 
                                        ...
                                        if ($rsDatos) {
                                            ...
                                            while ($row = $rsDatos->fetch_assoc()) {
                                                $botonSeleccionar = "<button  onclick='AgregarProductoGeneral(\"".$row["upc"]."\",\"".$row["codigo_producto"]."\",\"".$row["unidades_empaque"]."\",0,\"".$row["descripcion"]."\",0);' title='' type='button' class='btn btn-danger  btn-xs remove show_tip' data-original-title='Borrar'><span class='glyphicon glyphicon-trash'></span></button>";
                                                echo "<tr class=''>
          ...
          <div class="col-xs-12 col-sm-4">   
            <div class="alert alert-success" role="alert">
              <div id="div_precio_final" class="input-group" style="margin-bottom: 5px !important; display:none;">
                ...
                <input type="number" pattern="[0-9]+([\,|\.][0-9]+)?" class="form-control" id="precio_final" placeholder="Ingrese cantidad..." min="0" step="0.01">
              </div>   
              <div id="div_agregar_producto" class="input-group">  
                <input type="number" class="form-control" id="cantidad_solicitar" placeholder="Ingrese cantidad..." min="0" step="1">
